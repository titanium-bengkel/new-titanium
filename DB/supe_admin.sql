...
--
-- Host: localhost
-- Waktu pembuatan: 29 Jul 2024 pada 02.25
...
(1, 'developer', 'developer01', 'Developer', 'Semarang', '082250706412', 'mfikryrid@gmail.com', 'aktif', '1', 'Developer', '2024-07-26 15:36:42', '2024-07-26 15:36:42', NULL),
(2, 'affatar', 'thelegendofaffa', 'Affatar', 'Poncolowo', '-', 'affatarthelegendofaffa@gmail.com', 'Aktif', 'superadvisor', NULL, '2024-07-27 06:52:39', '2024-07-27 06:52:39', NULL);

-- --------------------------------------------------------

--
-- Struktur dari tabel `auth_user_level`
--
...
--
-- Indeks untuk tabel `auth_user_level`
--
ALTER TABLE `auth_user_level`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT untuk tabel `auth_user_level`
--
ALTER TABLE `auth_user_level`

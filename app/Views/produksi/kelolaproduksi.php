...
<header class="d-flex justify-content-between align-items-center border-bottom pb-3 mb-3"
    ...
    <div class="breadcrumb-wrapper" style="font-size: 14px;">
        ...
        <span class="breadcrumb-current text-muted">Kelola Produksi</span>
    </div>
    <h5 class="page-title mb-0 fw-bold">Kelola Produksi</h5>
</header>
...
<div id="progressModal"
    ...
    <div
        ...
        <form method="post" action="/produksi/update-kelola">
            <?= csrf_field() ?>

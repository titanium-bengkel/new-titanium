    ...
    <div class="row">
        <div style=" margin-top: 15px; margin-bottom: 10px; font-size: 12px; padding: 10px 20px; border-radius: 8px; display: inline-block;">
            <div style="font-size: 14px; font-weight: bold;">
                ...
                <span style="color: #6c757d; font-weight: 500;">Update Kwitansi</span>
            </div>
        </div>
        <form method="post" action="<?= base_url('updateKwitansi/' . $nomor) ?>">
            <div class="col-md-12">
                <div class="card">
                    <header class="mb-3 mt-4" style="border-bottom: 2px solid #6c757d; padding-bottom: 10px;">
                        <h5 class="ms-3">Update Kwitansi</h5>
                    </header>
                    <div class="card-body">
                        <h5>ID</h5>
                        <div class="form-group row align-items-center">
                            ...
                            <div class="col-lg-10 col-9 mb-3">
                                <input type="text" id="nomor" class="form-control" name="nomor" value="<?= $kwitansi[0]['nomor'] ?>" readonly>
                            </div>
                            ...
                            <div class="col-lg-10 col-7 mb-3">
                                <input type="date" id="tgl" class="form-control" name="tgl" value="<?= $kwitansi[0]['tanggal'] ?>" onkeydown="return false" onclick="this.showPicker()">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row align-items-center">
                            ...
                            <div class="col-lg-9 col-7 mb-3">
                                <input type="text" id="no_order" class="form-control" name="no_order" value="<?= $kwitansi[0]['no_order'] ?>" readonly>
                            </div>
                            ...
                            <div class="col-lg-10 col-7 mb-3">
                                <input type="text" id="no_kendaraan" class="form-control" name="no_kendaraan" value="<?= $kwitansi[0]['no_kendaraan'] ?>">
                            </div>
                            <div class="col-lg-2 col-3 mb-3">
                                <label class="col-form-label" for="jenis-mobil">Jenis Mobil</label>
                            </div>
                            <div class="col-lg-10 col-7 mb-3">
                                <input type="text" id="jenis-mobil" class="form-control" name="jenis-mobil" value="<?= $kwitansi[0]['jenis_mobil'] ?>">
                            </div>
                            <div class="col-lg-2 col-3 mb-3">
                                <label class="col-form-label" for="warna">Warna</label>
                            </div>
                            <div class="col-lg-10 col-7 mb-3">
                                <input type="text" id="warna" class="form-control" name="warna" value="<?= $kwitansi[0]['warna'] ?>">
                            </div>
                            <div class="col-lg-2 col-3 mb-3">
                                <label class="col-form-label" for="customer-name">Customer Name</label>
                            </div>
                            <div class="col-lg-10 col-9 mb-3">
                                <input type="text" id="customer-name" class="form-control" name="customer-name" value="<?= $kwitansi[0]['customer_name'] ?>">
                            </div>
                            <div class="col-lg-2 col-3 mb-3">
                                <label class="col-form-label" for="no-contact">No Contact</label>
                            </div>
                            <div class="col-lg-10 col-9 mb-3">
                                <input type="text" id="no-contact" class="form-control" name="no-contact" value="<?= $kwitansi[0]['no_contact'] ?>">
                            </div>
                            <div class="col-lg-2 col-3 mb-3">
                                <label class="col-form-label" for="tahun-mobil">Tahun Mobil</label>
                            </div>
                            <div class="col-lg-10 col-9 mb-3">
                                <input type="text" id="tahun-mobil" class="form-control" name="tahun-mobil" value="<?= $kwitansi[0]['tahun_mobil'] ?>">
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-lg-10 col-9">
                                    <input type="text" id="asuransi" class="form-control" name="asuransi" value="<?= $kwitansi[0]['asuransi'] ?>" oninput="updateInvoiceButtons()">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-10 col-9">
                                <input type="text" id="jasa" class="form-control" name="jasa" value="<?= $kwitansi[0]['jasa'] ?>" oninput="formatCurrency(this); calculateTotal()">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-lg-2 col-3">
                            ...
                            <div class="col-lg-10 col-9">
                                <input type="text" id="sparepart" class="form-control" name="sparepart" value="<?= $kwitansi[0]['sparepart'] ?>" oninput="formatCurrency(this); calculateTotal()">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-lg-2 col-3">
                            ...
                            <div class="col-lg-10 col-9">
                                <input type="text" id="nilai-total" class="form-control" name="nilai-total" value="<?= $kwitansi[0]['nilai_total'] ?>" readonly>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-10 col-9">
                                <select id="jenis-bayar" class="form-select" name="jenis-bayar">
                                    ...
                                    <option value="Cash" <?= $kwitansi[0]['jenis_bayar'] == 'Cash' ? 'selected' : '' ?>>Cash</option>
                                    <option value="Transfer BCA" <?= $kwitansi[0]['jenis_bayar'] == 'Transfer BCA' ? 'selected' : '' ?>>Transfer BCA</option>
                                    <option value="Piutang" <?= $kwitansi[0]['jenis_bayar'] == 'Piutang' ? 'selected' : '' ?>>Piutang</option>
                                    <option value="Titip" <?= $kwitansi[0]['jenis_bayar'] == 'Titip' ? 'selected' : '' ?>>Titip</option>
                                </select>
                            </div>
                        </div>
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-4 col-9">
                                <input type="date" id="tgl-masuk" class="form-control" name="tgl-masuk" value="<?= $kwitansi[0]['tanggal_masuk'] ?>" onkeydown="return false" onclick="this.showPicker()">
                            </div>
                            <div class="col-lg-2 col-3">
                                <label class="col-form-label" for="tgl-selesai">Tanggal Selesai</label>
                            </div>
                            <div class="col-lg-4 col-9">
                                <input type="date" id="tgl-estimasi" class="form-control" name="tgl-estimasi" value="<?= $kwitansi[0]['tanggal_selesai'] ?>" onkeydown="return false" onclick="this.showPicker()">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-lg-2 col-3">
                            ...
                            <div class="col-lg-10 col-9">
                                <textarea class="form-control" id="keterangan" name="keterangan" rows="1"><?= $kwitansi[0]['keterangan'] ?></textarea>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-lg-2 col-3">
                            ...
                            <div class="col-lg-10 col-9">
                                <input type="date" id="tgl_kirim_kwitansi" class="form-control" name="tgl_kirim_kwitansi" value="<?= $kwitansi[0]['tanggal_kirim_kwitansi'] ?>" onkeydown="return false" onclick="this.showPicker()">
                            </div>
                        </div>
                        <div class="d-flex col-lg-10 col-4">
                            <button type="submit" class="btn btn-sm btn-primary me-2">Simpan</button>
                            <button type="button" class="btn btn-sm btn-danger me-2">Batal</button>
                            <button type="button" class="btn btn-sm btn-success" id="btn-invoice-asuransi" style="margin-left: 20px; display: none;">Invoice to Asuransi</button>
                            <button type="button" class="btn btn-sm btn-success" id="btn-invoice-umum" style="display: none;">Invoice to Umum</button>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    function updateInvoiceButtons() {
        const asuransiValue = document.getElementById('asuransi').value;
        const btnInvoiceAsuransi = document.getElementById('btn-invoice-asuransi');
        const btnInvoiceUmum = document.getElementById('btn-invoice-umum');

        if (asuransiValue === 'Umum/Pribadi') {
            btnInvoiceUmum.style.display = 'block'; // Tampilkan tombol invoice ke Umum
            btnInvoiceAsuransi.style.display = 'none'; // Sembunyikan tombol invoice ke Asuransi
        } else {
            btnInvoiceAsuransi.style.display = 'block'; // Tampilkan tombol invoice ke Asuransi
            btnInvoiceUmum.style.display = 'none'; // Sembunyikan tombol invoice ke Umum
        }
    }

    // Panggil fungsi saat halaman dimuat untuk mengatur tampilan tombol yang benar
    window.onload = updateInvoiceButtons;
</script>

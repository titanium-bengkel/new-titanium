    ...
    <div class="row">
        <div style=" margin-top: 15px; margin-bottom: 10px; font-size: 12px; padding: 10px 20px; border-radius: 8px; display: inline-block;">
            <div style="font-size: 14px; font-weight: bold;">
                ...
                <span style="color: #6c757d; font-weight: 500;">Update Kwitansi RO</span>
            </div>
        </div>
        <form method="post" action="<?= base_url('updateKwitansiOR/' . $nomor) ?>">
            <div class="col-md-12">
                <div class="card">
                    <header class="mb-3 mt-4" style="border-bottom: 2px solid #6c757d; padding-bottom: 10px;">
                        <h5 class="ms-3">Update Kwitansi RO</h5>
                    </header>
                    <div class="card-body">
                        <h5>ID</h5>
                        <input type="hidden" name="id_repair_order" value="<?= isset($kwitansi['id_repair_order']) ? $kwitansi['id_repair_order'] : ''; ?>">
                        ...
                        <div class="form-group row align-items-center">
                            ...
                            <div class="col-lg-10 col-9 mb-3">
                                <input type="text" id="nomor" class="form-control" name="nomor" value="<?= isset($kwitansi[0]['nomor']) ? $kwitansi[0]['nomor'] : ''; ?>" readonly>
                            </div>
                            ...
                            <div class="col-lg-10 col-7 mb-3">
                                <input type="date" id="tgl" class="form-control" name="tgl" value="<?= isset($kwitansi['tanggal']) ? $kwitansi['tanggal'] : ''; ?>" onkeydown="return false" onclick="this.showPicker()">
                            </div>
                            <div class="col-lg-2 col-3 mb-3">
                                <label class="col-form-label" for="jatuh-tempo">Jatuh Tempo</label>
                            </div>
                            <div class="col-lg-10 col-7 mb-3">
                                <input type="date" id="jatuh_tempo" class="form-control" name="jatuh_tempo" value="<?= isset($kwitansi['jatuh_tempo']) ? $kwitansi['jatuh_tempo'] : ''; ?>" onkeydown="return false" onclick="this.showPicker()" required>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group row align-items-center">
                            ...
                            <div class="col-lg-10 col-9 mb-3">
                                <input type="text" id="asuransi" class="form-control" name="asuransi" value="<?= $kwitansi[0]['asuransi'] ?>">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row mb-3" style="display: none;">
                            ...
                            <div class="col-lg-10 col-9">
                                <input type="text" id="nilai-total" class="form-control" name="nilai-total" value="<?= $kwitansi[0]['nilai_total'] ?>" readonly style="display: none;">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-lg-2 col-3">

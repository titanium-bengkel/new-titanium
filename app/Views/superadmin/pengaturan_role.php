                                                                    ...
                                                                    <div class="ms-3">
                                                                        <div>
                                                                            <input type="checkbox"
                                                                                ...
                                                                                name="estperbaikan"
                                                                                onchange="handleUbahAnak(event, '<?= $l['id'] ?>')"
                                                                                <?= in_array('Estimasi Perbaikan', $l['fiturnya']) ? 'checked' : '' ?>>
                                                                            <label
                                                                                for="estperbaikan<?= $l['id'] ?>">Est.
                                                                                Perbaikan</label>
                                                                        </div>
                                                                        <div>
                                                                            <input type="checkbox"
                                                                                ...
                                                                                onchange="handleUbahAnak(event, '<?= $l['id'] ?>')"
                                                                                <?= in_array('Approval Asuransi', $l['fiturnya']) ? 'checked' : '' ?>>
                                                                            <label
                                                                                for="orderlist_asuransi<?= $l['id'] ?>">Approval
                                                                                Asuransi</label>
                                                                        </div>
                                                                        <div>
                                                                            <input type="checkbox"
                                                                                ...
                                                                                name="repair_order"
                                                                                onchange="handleUbahAnak(event, '<?= $l['id'] ?>')"
                                                                                <?= in_array('Work Order', $l['fiturnya']) ? 'checked' : '' ?>>
                                                                            <label
                                                                                for="repair_order<?= $l['id'] ?>">Work
                                                                                Order</label>
                                                                        </div>
                                                                        <div>
                                                                            <input type="checkbox"

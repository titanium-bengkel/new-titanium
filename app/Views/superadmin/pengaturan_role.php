                                                                        ...
                                                                        <div class="ms-3">
                                                                            ...
                                                                            <div>
                                                                                <input type="checkbox"
                                                                                    ...
                                                                                    name="kelolarole"
                                                                                    onchange="handleUbahAnak(event, '<?= $l['id'] ?>')"
                                                                                    <?= in_array('Kelola Role', $l['fiturnya']) ? 'checked' : '' ?>>
                                                                                <label
                                                                                    for="kelolarole<?= $l['id'] ?>">Kelola
                                                                                    Role</label>
                                                                            </div>
                                                                            <!-- <div>
                                                                            <input type="checkbox"
                                                                            ...
                                                                            <div>
                                                                                <input type="checkbox"
                                                                                    ...
                                                                                    <?= in_array('Pengaturan Role', $l['fiturnya']) ? 'checked' : '' ?>
                                                                                    <?= session()->get('role_label') !== 'direktur' ? 'disabled' : '' ?>
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        <div class="ms-3">
                                                                            <div>
                                                                                ...
                                                                                <label for="estperbaikan<?= $l['id'] ?>">Pre
                                                                                    Order</label>
                                                                            </div>
                                                                            <div>
                                                                                <input type="checkbox"
                                                                            ...
                                                                            <div>
                                                                                ...
                                                                                <label
                                                                                    for="kwitansi_piutang<?= $l['id'] ?>">Pending
                                                                                    Payment</label>
                                                                            </div>
                                                                            <div>
                                                                                <input type="checkbox"

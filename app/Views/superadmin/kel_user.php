        ...
        <div class="modal-content">
            ...
            <form action="<?= base_url('supercontroller/updateUser') ?>" method="post">
                ...
                <div class="modal-body">
                    ...
                    <input type="text" class="form-control mb-2" id="edit_nama_user" name="nama_user" required>
                    <input type="text" class="form-control mb-2" id="edit_alamat" name="alamat" required>
                    <input type="text" class="form-control mb-2" id="edit_kontak" name="kontak" required>
                    ...
                    <select class="form-select mb-2" id="edit_level" name="level" required>
                        <option value="direktur">Direktur</option>
                        <option value="manager">Manager</option>
                        <option value="keuangan">Keuangan</option>
                        <option value="admin">Admin</option>

            ...
            <div class="card">
                <header class="d-flex justify-content-between align-items-center border-bottom pb-3 mb-0" style="border-color: #6c757d; padding: 15px 20px;">
                    <div class="breadcrumb-wrapper" style="font-size: 14px;">
                        ...
                        <span class="breadcrumb-current text-muted">Sparepart Dalam Pesanan</span>
                    </div>
                    <h5 class="page-title mb-0 fw-bold">Sparepart Dalam Pesanan</h5>
                </header>
                        ...
                        <table class="table table-bordered table-striped -table-hover mb-0" id="po_bahan_table">
                                ...
                                <?php if (!empty($part)) : ?>
                                    ...
                                    foreach ($part as $detail) :
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-start"><?= $detail['id_pesan'] ?></td>
                                        </tr>
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-end" id="totalHarga" style="text-align: center;"></th>
                                    <th colspan="2"></th>
                                </tr>
                            </thead>
